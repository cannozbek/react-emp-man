...
const Pagination = ({pages, setCurrentPage, currentEmployees, sortedEmployee}) => {
    ...
    return (
        <div className="clearfix">
            <div className="hint-text">Showing <b>{currentEmployees.length}</b> out of <b>{sortedEmployee.length}</b> entries</div>
