...
const EmployeeContextProvider = (props) => {
    ...
    const sortedEmployee = employees.sort((a,b) => a.name.localeCompare(b.name));
    ...
    return (
        ...
        <EmployeeContext.Provider value={{employees, addEmployee, deleteEmployee, updateEmployee, sortedEmployee}}>
            {props.children}
